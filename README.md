...
## 🧠 Precision Psychiatry Treatment Prediction
...
*   **Clinical Trust Measures:**
    *   **Uncertainty Estimation:** Monte Carlo Dropout provides confidence scores (e.g., "82% ± 4%").
...
MO_AFN_Project/
├── data/
│   ├── raw/                  # Source files (GEO/PGC downloads)
│   └── synthetic/            # Generated mock tensors for testing
│
├── src/
│   ├── data_acquisition/     # Scripts to fetch data from NCBI/Kaggle
│   ├── preprocessing/        # Phase 1: Autoencoders & QC logic
│   ├── models/               # Phase 2: MO-AFN Network & Optuna Optimization
│   ├── training/             # Phase 3: Clinical Trainer (Weighted Loss)
│   └── evaluation/           # Phase 4: Visualization Suite (EDA, XAI, Metrics)
│
├── notebooks/
│   └── figures/              # Generated high-quality plots
│       ├── eda/              # Exploratory Data Analysis
│       ├── evaluation/       # Benchmarks & UMAP
│       ├── performance/      # ROC/PR Curves
│       └── xai/              # SHAP & Radar Charts
│
└── docs/                     # Data Access Requests & Documentation
```
